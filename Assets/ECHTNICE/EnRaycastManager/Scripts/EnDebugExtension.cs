...
public static class EnDebugExtension {

    public static Vector3 RotateDirection(Transform t, Vector3 dir) {
        return t.rotation * dir; // returns new position of the point;
    }

    public static Vector3 RotateDirectionInverse(Transform t, Vector3 dir) {
        return Quaternion.Inverse(t.rotation) * dir; // returns new position of the point;
    }

    public static Vector3 RotatePoint(Transform t, Vector3 point) {
        return t.position + (t.rotation * (point - t.position)); // returns new position of the point;
    }

    public static Vector3 RotatePointInverse(Transform t, Vector3 point) {
        return t.position + (Quaternion.Inverse(t.rotation) * (point - t.position)); // returns new position of the point;
    }
    ...
    public static void DebugWireSphereCast(Vector3 start, float radius, Vector3 direction, float distance, Color color, int duration = 60) {
        Debug.DrawLine(start, start + direction * distance, color, duration);
        EnDebugExtension.DebugWireSphere(start, color, radius, duration);
        EnDebugExtension.DebugWireSphere(start + direction * distance, color, radius, duration);
    }
    ...
    public static void DebugCylinder(Vector3 start, Vector3 end, Color color, float radius = 1, float duration = 0, bool depthTest = true) {
        ...
        //Radial circles
        EnDebugExtension.DebugCircle(start, up, color, radius, duration, depthTest);
        EnDebugExtension.DebugCircle(end, -up, color, radius, duration, depthTest);
        EnDebugExtension.DebugCircle((start + end) * 0.5f, up, color, radius, duration, depthTest);
    ...
    public static void DebugCone(Vector3 position, Vector3 direction, Color color, float angle = 45, float duration = 0, bool depthTest = true) {
        ...
        EnDebugExtension.DebugCircle(position + _forward, direction, color, (_forward - (slerpedVector.normalized * dist)).magnitude, duration, depthTest);
        EnDebugExtension.DebugCircle(position + (_forward * 0.5f), direction, color, ((_forward * 0.5f) - (slerpedVector.normalized * (dist * 0.5f))).magnitude, duration, depthTest);
    }
    ...
    public static void DebugArrow(Vector3 position, Vector3 direction, Color color, float duration = 0, bool depthTest = true) {
        ...
        EnDebugExtension.DebugCone(position + direction, -direction * 0.333f, color, 15, duration, depthTest);
    }
    ...
    public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1.0f) {
        ...
        //Radial circles
        EnDebugExtension.DrawCircle(start, up, color, radius);
        EnDebugExtension.DrawCircle(end, -up, color, radius);
        EnDebugExtension.DrawCircle((start + end) * 0.5f, up, color, radius);
    ...
    public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45) {
        ...
        EnDebugExtension.DrawCircle(position + _forward, direction, color, (_forward - (slerpedVector.normalized * dist)).magnitude);
        EnDebugExtension.DrawCircle(position + (_forward * 0.5f), direction, color, ((_forward * 0.5f) - (slerpedVector.normalized * (dist * 0.5f))).magnitude);
    ...
    public static void DrawArrow(Vector3 position, Vector3 direction, Color color) {
        ...
        EnDebugExtension.DrawCone(position + direction, -direction * 0.333f, color, 15);
    ...
    public static void DebugCapsuleCast(Vector3 start, Vector3 end, float radius, Vector3 direction, float distance, Color color, int duration = 60) {
        var startWithRadius = start + (direction * radius);
        var endWithRadius = end + (direction * radius);

        Debug.DrawLine(startWithRadius, startWithRadius + direction * distance, color, duration);
        Debug.DrawLine(endWithRadius, endWithRadius + direction * distance, color, duration);
        EnDebugExtension.DebugCapsule(startWithRadius, endWithRadius, color, radius, duration);
        EnDebugExtension.DebugCapsule(startWithRadius + direction * distance,
            endWithRadius + direction * distance, color, radius, duration);
    }
